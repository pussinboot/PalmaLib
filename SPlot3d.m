...
function Output(block)
  ...
  plot(block.InputPort(1).Data, block.InputPort(2).Data, block.InputPort(3).Data, block.InputPort(4).Data, block.InputPort(5).Data, block.InputPort(6).Data, block.InputPort(7).Data);
  ylim([0 1.1]);
  legend(block.InputPort(1).Data,'Observed','Fit 1','Fit 2','Location','SouthEast');
  %legend boxoff
